...
export function createPerformanceFromDelivery(application: Application): Performance {
  ...
  return {
    ...
    snapshot: {
      ...
      ...(application.snapshot.supplierProductKey ? { supplierProductKey: application.snapshot.supplierProductKey } : {}),
      ...(application.snapshot.commercialType ? { commercialType: application.snapshot.commercialType } : {}),
      ...(application.snapshot.vehiclePrice !== undefined ? { vehiclePrice: application.snapshot.vehiclePrice } : {}),
