/**
 * Reverse-imported pure fee-rule table from:
 *   freepass-creator/fp-settlement
 *   path: lib/domain/settlement-fee-table.ts
 *   blob: ccc8b5456c79a00f00c3795ee87b94061f96791f
 *
 * This copy intentionally contains only the proven pure rule table.
 * UI/Auth/Firestore/RTDB code from fp-settlement is NOT imported.
 *
 * When upstream rules change, update this provenance and run parity fixtures
 * before promoting the new revision.
 */
