...
> Canonical 상품 → 검색/필터 → 상품상세 → 접수 → 접수목록 → 접수상세 → 계약서/필수서류/잔금/인도/취소
...
접수목록은 세로 스크롤 중심이며 각 카드/행에서 고객, 차량, 접수번호, 핵심 조건, 계약서/필수서류/잔금/인도 체크를 빠르게 파악한다. 접수 항목을 더블클릭하면 오른쪽 패널이 접수상세로 전환된다.
...
7. Application List
8. Application Detail + 계약서/필수서류/잔금/인도/취소
...
6. 접수목록에 새 접수가 나타난다.
7. 접수상세를 열어 계약서/필수서류/잔금/인도를 확인한다.
